...
import com.ajou.ase.user.UserDaoImpl;


@Service("userService")
public class UserServiceImpl implements com.ajou.ase.common.Service {
	...
	public List getListByUnConfirmed(Object obj) throws SQLException {
		return this.dao.getListByUnconfirmed(obj);
	}
